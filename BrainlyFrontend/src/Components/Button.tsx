...
export const Button = (props : Buttonprops)=>{
   return (
    <button  disabled= {props.loding} className={`${defaultStyle} ${(props.loding ? "opacity-45" : "")} ${varirantStyle[props.variants]}  ${SizeStyle[props.size]} `} onClick={props.onClick}>{props.startIcon}  { props.text }  </button>
   )
}